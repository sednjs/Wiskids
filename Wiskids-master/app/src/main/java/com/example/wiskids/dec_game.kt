...
import com.example.wiskids.databinding.ActivityDecGameBinding
import java.util.concurrent.TimeUnit

class dec_game : AppCompatActivity() {
    lateinit var binding: ActivityDecGameBinding
    val que = arrayOf(R.drawable.dq1, R.drawable.dq2, R.drawable.dq3, R.drawable.dq4, R.drawable.dq5)
    val answer = arrayListOf<String>("1.32","0.31","1.85","0.789","0.033")
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityDecGameBinding.inflate(layoutInflater)
